 ...
 with
filtered_events as 
(select geo_country, ga_session_id, user_id, REPLACE(replace(event_name,'-','_'), ' ','_') as event_name, event_timestamp
...
session_user_id as 
(
  select distinct  geo_country,ga_session_id ,user_id 
